...
case $1 in
	...
	bk7252n)
		...
		new_linkscript=config/bk7252n_boot.lds
		new_rt_config=config/rtconfig/rtconfig_bk7252n.h
		;;
	bk7251)
...
# Generate .config for scons building
...
# macOS sed -i requires an argument, while Linux sed -i doesn't
