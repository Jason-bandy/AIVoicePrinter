...
#define RX_CNTRL_REORD_POOL_SIZE        (NX_MAX_BA_RX)
/// Size of the windows used in reordering operations
#define RX_CNTRL_REORD_WIN_SIZE         (NX_AMPDU_RX_BUF_SIZE)
...
#if NX_AMPDU_RX && ((2 * NX_AMPDU_RX_BUF_SIZE) > RX_MIN_STAT_DESC_CNT)
#define RX_STAT_DESC_CNT      (2 * NX_AMPDU_RX_BUF_SIZE)
#else
...
extern struct rxu_stat_desc rxu_stat_desc_pool[RX_STAT_DESC_CNT];
...
/**
 ****************************************************************************************
 * @brief Check if a RX status descriptor is available.
 *
