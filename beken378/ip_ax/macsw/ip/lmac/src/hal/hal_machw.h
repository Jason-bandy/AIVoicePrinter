...
/**
 ****************************************************************************************
 * @brief absolute difference between current time and past time to compare.
 *
 * @param[in] time Time to compare.
 *
 ...
 ****************************************************************************************
 */
__INLINE uint32_t hal_machw_time_diff_current_time(uint32_t time)
{
    uint32_t diff = hal_machw_time() - time;
