...
/**
 ****************************************************************************************
 * @brief Indicate control layer that the primary TBTT is pending
 *
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Indicate control layer that the secondary TBTT is pending
 *
 ****************************************************************************************
 */
...
uint32_t macif_rx_buf_get(uint32_t *host_id, int len);
#else
...
/**
 ****************************************************************************************
 * @brief Process RX status descriptors at the application level
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Concatenate RX buffer.
 * @param[in] host_id   Original RX Buf
 * @param[in] new_host_id   newly rx buf
 *
 * @return true if concatenate successful.
 ****************************************************************************************
 */
int macif_rx_buf_concat(uint32_t host_id, uint32_t new_host_id);
int __must_check fhost_txbuf_push(void *desc, uint8_t queue_idx);
int __must_check fhost_txbuf_prepend(void *desc, uint8_t queue_idx);
