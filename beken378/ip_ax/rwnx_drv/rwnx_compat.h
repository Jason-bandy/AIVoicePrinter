...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3, 19, 0)
#define rwnx_cfg80211_del_station_compat(wiphy, dev, params) \
    rwnx_cfg80211_del_station(wiphy, dev, const u8 *mac)
#else
#define rwnx_cfg80211_del_station_compat rwnx_cfg80211_del_station
#endif
