...
static void flash_bypass_command_test(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    if(argc == 5)
    {
        ...
        extern bk_err_t flash_bypass_get_otp_lock_bit(flash_bypass_otp_ctrl_t *param);
        ...
        case 'W':
            ...
            break;
        case 'L':
            flash_bypass_otp_operation(CMD_OTP_LOCK, &otp_cfg);
            break;
        case 'I':
        ...
        case 'S':
            ...
            break;
        case 'C':
            flash_bypass_get_otp_lock_bit(&otp_cfg);
            break;
        default:
            break;
        }
...
#if ((CFG_SOC_NAME != SOC_BK7231) && (CFG_SUPPORT_BLE == 1) && (CFG_BLE_USE_CLI == 1) && (CFG_BLE_HOST_RW == 1))
#if (CFG_BLE_VERSION == BLE_VERSION_4_2)
#include "ble_api.h"
...
static const struct cli_command built_ins[] =
{
    ...
    {"flash_bypass", "flash_bypass [R/E/W/L] [otp_idx:1/2/3] [addr_offset] [length]", flash_bypass_command_test},
    #endif
    #endif
