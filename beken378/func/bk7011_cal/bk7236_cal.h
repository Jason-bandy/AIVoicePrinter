...
typedef union
{
    struct
    {
        volatile unsigned int rf_en          : 1;  /**< RF使能信号 */
        volatile unsigned int rf_spi_reset   : 1;  /**< RF SPI总线上的寄存器复位信号 */
        volatile unsigned int rf_adc_clk_inv : 1;  /**< RF ADC Clock invert */
        volatile unsigned int rf_dac_clk_inv : 1;  /**< RF DAC clock invert */
        volatile unsigned int Reserved       : 4;  /**< NC */
        volatile unsigned int spi_prescaler  : 6;  /**< SPI时钟频率控制=RC_Clock (80 MHz)/2/PRESCALE*/
        volatile unsigned int Reserved_      : 10; /**< NC */
        volatile unsigned int rf_state       : 4;  /**< RF状态指示 */
        volatile unsigned int rf_pll_unlock  : 1;  /**< RF PLL Unlock指示 */
        volatile unsigned int rf_lna_sat     : 3;  /**< RF LNA信号饱和指示 */
    } bits;
...
#if 0
/*
Seg1=rf_lna_sat |31:29 |0h | |RF LNA信号饱和指示
Seg2=rf_pll_unlock |28 |0h | |RF PLL Unlock指示
Seg3=rf_state |27:24 |0h | |RF状态指示
Seg4=Reserved |23:14 |0h | |NC
Seg5=spi_prescaler |13:8 |0h | |SPI时钟频率控制=RC_Clock (80 MHz)/2/PRESCALE
Seg6=Reserved |7:4 |0h | |NC
Seg7=rf_dac_clk_inv |3 |0h | |RF DAC clock invert
Seg8=rf_adc_clk_inv |2 |0h | |RF ADC Clock invert
Seg9=rf_spi_reset |1 |0h | |RF SPI总线上的寄存器复位信号
Seg10=rf_en |0 |0h | |RF使能信号
...
typedef union
{
    struct
    {
        volatile unsigned int force_en       : 1;  /**< 强制控制RF接口信号 */
        volatile unsigned int force_shutdown : 1;  /**< 强制模式下的SHDN */
        volatile unsigned int force_rx_on    : 1;  /**< 强制模式下的RXEN */
        volatile unsigned int force_tx_on    : 1;  /**< 强制模式下的TXEN */
        volatile unsigned int force_pre_gain : 10; /**< 强制模式下发送功率控制 */
        volatile unsigned int Reserved       : 18; /**< NC */
    } bits;
    volatile unsigned int value;
...
BitNumber=32
SegNumber=6
Seg1=Reserved |31:14 |0h | |NC
Seg2=force_pre_gain |13:4 |200h | |强制模式下发送功率控制
Seg3=force_tx_on |3 |0h | |强制模式下的TXEN
Seg4=force_rx_on |2 |0h | |强制模式下的RXEN
Seg5=force_shutdown |1 |0h | |强制模式下的SHDN
Seg6=force_en |0 |0h | |强制控制RF接口信号
[END1]
...
typedef union
{
    struct
    {
        volatile unsigned int rx_on_delay   : 10; /**< 接收开启延时 */
        volatile unsigned int Reserved      : 6;  /**< NC */
        volatile unsigned int rx_off_delay  : 10; /**< 接收关闭延时 */
        volatile unsigned int Reserved_     : 6;  /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x2_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int tx_on_delay   : 10; /**< 发送开启延时 */
        volatile unsigned int Reserved      : 6;  /**< NC */
        volatile unsigned int tx_off_delay  : 10; /**< 发送关闭延时 */
        volatile unsigned int Reserved_     : 6;  /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x3_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int pa_on_delay   : 10; /**< PA开启延时 */
        volatile unsigned int Reserved      : 6;  /**< NC */
        volatile unsigned int pa_off_delay  : 10; /**< PA关闭延时 */
        volatile unsigned int Reserved_     : 6;  /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x4_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int shdn_on_delay   : 10; /**< 进入Shutdown延时 */
        volatile unsigned int Reserved        : 6;  /**< NC */
        volatile unsigned int shdn_off_delay  : 10; /**< 退出Shutdown延时 */
        volatile unsigned int Reserved_       : 6;  /**< NC */
    } bits;
    volatile unsigned int value;
...
typedef union
{
    struct
    {
        volatile unsigned int rx2tx_delay   : 10; /**< Rx To Tx 延时 */
        volatile unsigned int Reserved      : 22; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x6_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int tx_pattern        : 2; /**< 0：正常模式，发射正常来自Modem的数据 ;  1：I/Q发射常数;  2：I/Q发射满幅度正弦波;  3：I/Q发射三角波 */
        volatile unsigned int tx_iq_swap        : 1; /**< TX IQ SWAP */
        volatile unsigned int tx_comp_disable   : 1; /**< 发送补偿功能禁止:  0x0: 使能发送补偿;  0x1: 禁止发送补偿 */
        volatile unsigned int tx_powtbl_en      : 1; /**< Tx Power Table Enable;  0x0: 软件控制Table读写;  0x1: 硬件控制Table读 */
        volatile unsigned int tx_dpd_en         : 1; /**< Tx DPD Enable */
        volatile unsigned int tx_dpd_addr_scale : 1; /**< DPD 地址缩放:  0：1/2;  1: 1/4 */
        volatile unsigned int Reserved          : 9; /**< NC */
        volatile unsigned int rx_iq_swap        : 1; /**< RX IQ SWAP */
        volatile unsigned int Reserved_         : 1; /**< NC */
        volatile unsigned int rx_dc_calc_en     : 1; /**< 使能RX DC计算(1) */
        volatile unsigned int rx_calib_en       : 1; /**< 使能Mismatch计算(1) */
        volatile unsigned int rx_comp_en        : 1; /**< 使能Mismatch补偿(1) */
        volatile unsigned int rx_avg_mode       : 1; /**< 0：求取信号的平均值;  1：求取信号绝对值得平均值 */
        volatile unsigned int Reserved__        : 10; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x8_TypeDef;

#if 0
Seg1=Reserved |31:22 |0h | |NC
Seg2=rx_avg_mode |21 |0h | |0：求取信号的平均值;  1：求取信号绝对值得平均值
Seg3=rx_comp_en |20 |0h | |使能Mismatch补偿(1)
Seg4=rx_calib_en |19 |0h | |使能Mismatch计算(1)
Seg5=rx_dc_calc_en |18 |0h | |使能RX DC计算(1)
Seg6=Reserved |17 |0h | |NC
Seg7=rx_iq_swap |16 |0h | |RX IQ SWAP
Seg8=Reserved |15:7 |0h | |NC
Seg9=tx_dpd_addr_scale |6 |0h | |DPD 地址缩放:  0：1/2;  1: 1/4
Seg10=tx_dpd_en |5 |0h | |Tx DPD Enable
Seg11=tx_powtbl_en |4 |0h | |Tx Power Table Enable;  0x0: 软件控制Table读写;  0x1: 硬件控制Table读
Seg12=tx_comp_disable |3 |0h | |发送补偿功能禁止:  0x0: 使能发送补偿;  0x1: 禁止发送补偿
Seg13=tx_iq_swap |2 |0h | |TX IQ SWAP
Seg14=tx_pattern |1:0 |0h | |0：正常模式，发射正常来自Modem的数据 ;  1：I/Q发射常数;  2：I/Q发射满幅度正弦波;  3：I/Q发射三角波
...
typedef union
{
    struct
    {
        volatile unsigned int tx_const_q   : 12; /**< 当发射常数时，Q的值 */
        volatile unsigned int Reserved     : 4; /**< NC */
        volatile unsigned int tx_const_i   : 12; /**< 当发射常数时，I的值 */
        volatile unsigned int Reserved_    : 4; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x9_TypeDef;
#if 0
Seg1=Reserved |31:28 |0h | |NC
Seg2=tx_const_i |27:16 |0h | |当发射常数时，I的值
Seg3=Reserved |15:12 |0h | |NC
Seg4=tx_const_q |11:0 |0h | |当发射常数时，Q的值
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int tx_sin_mode     : 2; /**< 0：I/Q路发射复数正弦波;  1：仅仅I路发射，Q路发射0;  2：仅仅Q路发射，I路发射0;  3：保留 */
        volatile unsigned int Reserved        : 2; /**< NC */
        volatile unsigned int tx_sin_amp      : 4; /**< 正弦波幅度调整系数。小数表示，x.yyy。范围是[0 15/8] */
        volatile unsigned int tx_sin_freq     : 10;/**< 发射正弦波频率;  TX_SIN_F=2048*F/40，F是发射频率，单位MHz */
        volatile unsigned int Reserved_       : 6; /**< NC */
        volatile unsigned int tx_triangle_amp : 1; /**< 三角波幅度范围:  0： 2048~2560;  1： 2048~3072 */
        volatile unsigned int Reserved__      : 7; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0xA_TypeDef;

#if 0
Seg1=Reserved |31:25 |0h | |NC
Seg2=tx_triangle_amp |24 |0h | |三角波幅度范围:  0： 2048~2560;  1： 2048~3072
Seg3=Reserved |23:18 |0h | |NC
Seg4=tx_sin_freq |17:8 |0h | |发射正弦波频率;  TX_SIN_F=2048*F/40，F是发射频率，单位MHz
Seg5=tx_sin_amp |7:4 |0h | |正弦波幅度调整系数。小数表示，x.yyy。范围是[0 15/8]
Seg6=Reserved |3:2 |0h | |NC
Seg7=tx_sin_mode |1:0 |0h | |0：I/Q路发射复数正弦波;  1：仅仅I路发射，Q路发射0;  2：仅仅Q路发射，I路发射0;  3：保留
[END10]
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int tx_dc_q_comp  : 12; /**< Q DC offset */
        volatile unsigned int Reserved      : 4; /**< NC */
        volatile unsigned int tx_dc_i_comp  : 12; /**< I DC offset，[-512 511] */
        volatile unsigned int Reserved_     : 4; /**< NC */
    } bits;
    volatile unsigned int value;
...
#if 0
Seg1=Reserved |31:28 |0h | |NC
Seg2=tx_dc_i_comp |27:16 |0h | |I DC offset，[-512 511]
Seg3=Reserved |15:12 |0h | |NC
Seg4=tx_dc_q_comp |11:0 |0h | |Q DC offset，[-512 511]
...
typedef union
{
    struct
    {
        volatile unsigned int tx_gain_q_comp  : 12; /**< 0 ~ 1023/1024，step:1/1024 */
        volatile unsigned int Reserved        : 4;  /**< NC */
        volatile unsigned int tx_gain_i_comp  : 12; /**< 0 ~ 1023/1024，step:1/1024 */
        volatile unsigned int Reserved_       : 4;  /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0xC_TypeDef;
#if 0
Seg1=Reserved |31:28 |0h | |NC
Seg2=tx_gain_i_comp |27:16 |0h | | 0 ~ 1023/1024，step:1/1024
Seg3=Reserved |15:12 |0h | |NC
Seg4=tx_gain_q_comp |11:0 |0h | |0 ~ 1023/1024，step:1/1024
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int tx_ty2_comp   : 12; /**< 512/1024 ~ (512+1023)/1024，step:1/1024 */
        volatile unsigned int Reserved      : 4;  /**< NC */
        volatile unsigned int tx_phase_comp : 12; /**< -512/1024~ 511/1024，step:1/1024 */
        volatile unsigned int Reserved_     : 4;  /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0xD_TypeDef;
#if 0
Seg1=Reserved |31:28 |0h | |NC
Seg2=tx_phase_comp |27:16 |0h | |-512/1024~ 511/1024，step:1/1024
Seg3=Reserved |15:12 |0h | |NC
Seg4=tx_ty2_comp |11:0 |0h | |512/1024 ~ (512+1023)/1024，step:1/1024
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rx_avg_q_est  : 12; /**< Q路计算结果 */
        volatile unsigned int rx_avg_i_est  : 12; /**< I路计算结果 */
        volatile unsigned int Reserved      : 8; /**< NC */
    } bits;
    volatile unsigned int value;
...
#if 0
Seg1=Reserved |31:24 |0h | |NC
Seg2=rx_avg_i_est |23:12 |0h | |I路计算结果
Seg3=rx_avg_q_est |11:0 |0h | |Q路计算结果
...
typedef union
{
    struct
    {
        volatile unsigned int rx_dc_q_est  : 12; /**< Q路DC计算结果 */
        volatile unsigned int rx_dc_i_est  : 12; /**< I路DC计算结果 */
        volatile unsigned int Reserved     : 8; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0xF_TypeDef;
#if 0
Seg1=Reserved |31:24 |0h | |NC
Seg2=rx_dc_i_est |23:12 |0h | |I路DC计算结果
Seg3=rx_dc_q_est |11:0 |0h | |Q路DC计算结果
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rx_phase_err_est : 10; /**< 估计出来的相位误差，phase_err_est*2^9，有符号 */
        volatile unsigned int Reserved         : 6;  /**< NC */
        volatile unsigned int rx_amp_err_est   : 10; /**< 估计出来的幅度误差，amp_err_est*2^9，有符号 */
        volatile unsigned int Reserved_        : 6;  /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x10_TypeDef;
#if 0
Seg1=Reserved |31:26 |0h | |NC
Seg2=rx_amp_err_est |25:16 |0h | |估计出来的幅度误差，amp_err_est*2^9，有符号
Seg3=Reserved |15:10 |0h | |NC
Seg4=rx_phase_err_est |9:0 |0h | |估计出来的相位误差，phase_err_est*2^9，有符号
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rx_ty2_est  : 10; /**< 估计出来的TY2，(ty2-0.5)*2^10，有符号 */
        volatile unsigned int Reserved    : 22; /**< NC */
...
#if 0
Seg1=Reserved |31:10 |0h | |NC
Seg2=rx_ty2_est |9:0 |0h | |估计出来的TY2，(ty2-0.5)*2^10，有符号
...
typedef union
{
    struct
    {
        volatile unsigned int rx_dc_q_comp : 12; /**< 补偿时使用的Q路DC */
        volatile unsigned int rx_dc_i_comp : 12; /**< 补偿时使用的I路DC */
        volatile unsigned int Reserved     : 8;  /**< NC */
    } bits;
    volatile unsigned int value;
...
#if 0
Seg1=Reserved |31:24 |0h | |NC
Seg2=rx_dc_i_comp |23:12 |0h | |补偿时使用的I路DC
Seg3=rx_dc_q_comp |11:0 |0h | |补偿时使用的Q路DC
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rx_phase_err_comp : 10; /**< 补偿时使用的phase_err*ty2*2^9 */
        volatile unsigned int Reserved          : 6;  /**< NC */
        volatile unsigned int rx_amp_err_comp   : 10; /**< 补偿时使用的ty2/(1+amp_err)*2^9 */
        volatile unsigned int Reserved_         : 6;  /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x13_TypeDef;
#if 0
Seg1=Reserved |31:26 |0h | |NC
Seg2=rx_amp_err_comp |25:16 |0h | |补偿时使用的ty2/(1+amp_err)*2^9
Seg3=Reserved |15:10 |0h | |NC
Seg4=rx_phase_err_comp |9:0 |0h | |补偿时使用的phase_err*ty2*2^9
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rx_snr_noise : 9; /**< rx noise for sinar test */
        volatile unsigned int Reserved     : 7; /**< NC */
        volatile unsigned int rx_snr_sig   : 9; /**< rx signal for sinar test */
        volatile unsigned int Reserved_    : 7; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x14_TypeDef;
#if 0
Seg1=Reserved |31:25 |0h | |NC
Seg2=rx_snr_sig |24:16 |0h | |rx signal for sinar test
Seg3=Reserved |15:9 |0h | |NC
Seg4=rx_snr_noise |8:0 |0h | |rx noise for sinar test
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int tx_cal_cap_i      : 8; /**< I path calib capacity for transmit mode */
        volatile unsigned int rx_cal_cap_i      : 8; /**< I path calib capacity for receive mode */
        volatile unsigned int standby_cal_cap_i : 8; /**< I path calib capacity for standby mode */
        volatile unsigned int Reserved          : 8; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x15_TypeDef;
#if 0
Seg1=Reserved |31:24 |0h | |NC
Seg2=standby_cal_cap_i |23:16 |0h | |I path calib capacity for standby mode
Seg3=rx_cal_cap_i |15:8 |0h | |I path calib capacity for receive mode
Seg4=tx_cal_cap_i |7:0 |0h | |I path calib capacity for transmit mode
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int tx_cal_cap_q      : 8; /**< Q path calib capacity for transmit mode */
        volatile unsigned int rx_cal_cap_q      : 8; /**< Q path calib capacity for receive mode */
        volatile unsigned int standby_cal_cap_q : 8; /**< Q path calib capacity for standby mode */
        volatile unsigned int Reserved          : 8; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x16_TypeDef;
#if 0
Seg1=Reserved |31:24 |0h | |NC
Seg2=standby_cal_cap_q |23:16 |0h | |Q path calib capacity for standby mode
Seg3=rx_cal_cap_q |15:8 |0h | |Q path calib capacity for receive mode
Seg4=tx_cal_cap_q |7:0 |0h | |Q path calib capacity for transmit mode
#endif
...
typedef union
{
    ...
    {
        volatile unsigned int Reserved        : 8;  /**< NC */
        volatile unsigned int tx_pre_gain_2nd : 10; /**< 2nd stage PreGain  */
        volatile unsigned int Reserved_       : 14; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x17_TypeDef;
#if 0
Seg1=tx_pre_gain_2nd |17:8 |0h | |2nd stage PreGain 
Seg2=Reserved |7:0 |0h | |NC
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int agc_manual_en    : 1; /**< AGC手动设置使能 */
        volatile unsigned int Reserved         : 3; /**< NC */
        volatile unsigned int agc_pga_set      : 4; /**< agc手动设置PGA值 */
        volatile unsigned int agc_buf_set      : 1; /**< agc手动设置BUF值 */
        volatile unsigned int agc_lna_set      : 2; /**< agc手动设置LNA值 */
        volatile unsigned int agc_attent_set   : 1; /**< agc手动设置ATTENUATION值 */
        volatile unsigned int Reserved_        : 4; /**< NC */
        volatile unsigned int agc_pga_value    : 4; /**< AGC的PGA结果 */
        volatile unsigned int agc_buf_value    : 1; /**< AGC的BUF结果 */
        volatile unsigned int agc_lna_value    : 2; /**< AGC的LNA结果 */
        volatile unsigned int agc_attent_value : 1; /**< AGC的ATTENUATION结果 */
        volatile unsigned int Reserved__       : 8; /**< NC */

    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x18_TypeDef;
#if 0
Seg1=Reserved |31:24 |0h | |NC
Seg2=agc_attent_value |23 |0h | |AGC的ATTENUATION结果
Seg3=agc_lna_value |22:21 |0h | |AGC的LNA结果
Seg4=agc_buf_value |20 |0h | |AGC的BUF结果
Seg5=agc_pga_value |19:16 |0h | |AGC的PGA结果
Seg6=Reserved |15:12 |0h | |NC
Seg7=agc_attent_set |11 |0h | |agc手动设置ATTENUATION值
Seg8=agc_lna_set |10:9 |0h | |agc手动设置LNA值
Seg9=agc_buf_set |8 |0h | |agc手动设置BUF值
Seg10=agc_pga_set |7:4 |0h | |agc手动设置PGA值
Seg11=Reserved |3:1 |0h | |NC
Seg12=agc_manual_en |0 |0h | |AGC手动设置使能
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int tssi_calc_en    : 1;  /**< TSSI Calculate Enable */
        volatile unsigned int rx_snr_calc_en  : 1;  /**< Rx SNR Calculate enable */
        volatile unsigned int rx_snr_hpf_coef : 2;  /**< RX SNR HPF Coef　 */
        volatile unsigned int Reserved        : 4;  /**< NC */
        volatile unsigned int tssi_est        : 8;  /**< TSSI Estimate Value */
        volatile unsigned int Reserved_       : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x19_TypeDef;
#if 0
Seg1=Reserved |31:16 |0h | |NC
Seg2=tssi_est |15:8 |0h | |TSSI Estimate Value
Seg3=Reserved |7:4 |0h | |NC
Seg4=rx_snr_hpf_coef |3:2 |0h | |RX SNR HPF Coef　
Seg5=rx_snr_calc_en |1 |0h | |Rx SNR Calculate enable
Seg6=tssi_calc_en |0 |0h | |TSSI Calculate Enable
...
typedef union
{
    struct
    {
        volatile unsigned int rf_gain_nf_db : 6;  /**< RF Rx NF */
        volatile unsigned int Reserved      : 26; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x1A_TypeDef;
#if 0
Seg1=Reserved |31:6 |0h | |NC
Seg2=rf_gain_nf_db |5:0 |0h | |RF Rx NF 
...
typedef union
{
    struct
    {
        volatile unsigned int rf_path_gain   : 5;  /**< RF Paht Gain, cann't adjust */
        volatile unsigned int Reserved       : 3;  /**< NC */
        volatile unsigned int rf_attent_gain : 5;  /**< RF Attenuation Gain. */
        volatile unsigned int Reserved_      : 19; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x1B_TypeDef;
#if 0
Seg1=rf_attent_gain |12:8 |0h | |RF Attenuation Gain.
Seg2=rf_path_gain |4:0 |8h | |RF Paht Gain, can not adjust
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rx_adc_dBm : 8;  /**< Rx ADC Signal Power. Unit is dBm */
        volatile unsigned int Reserved   : 24; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x1C_TypeDef;
#if 0
Seg1=rx_adc_dBm |7:0 |0h | |Rx ADC Signal Power. Unit is dBm
/// REG0x1C
typedef union
{
    struct
...
typedef union
{
    ...
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x20_TypeDef;
...
typedef union
{
    ...
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x21_TypeDef;
...
typedef union
{
    ...
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x22_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_0db : 8;  /**< RF DC I Path Compensation during 0dB */
        volatile unsigned int rf_dc_q_comp_0db : 8;  /**< RF DC Q Path Compensation during 0dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x23_TypeDef;
#if 0
Seg1=Reserved |31:16 |0h | |NC
Seg2=rf_dc_q_comp_0db |15:8 |0h | |RF DC Q Path Compensation during 0dB
Seg3=rf_dc_i_comp_0db |7:0 |0h | |RF DC I Path Compensation during 0dB 
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_3db : 8;  /**< RF DC I Path Compensation during 3dB */
        volatile unsigned int rf_dc_q_comp_3db : 8;  /**< RF DC Q Path Compensation during 3dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x24_TypeDef;
#if 0
Seg1=Reserved |31:16 |0h | |NC
Seg2=rf_dc_q_comp_3db |15:8 |0h | |RF DC Q Path Compensation during 3dB
Seg3=rf_dc_i_comp_3db |7:0 |0h | |RF DC I Path Compensation during 3dB
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_6db : 8;  /**< RF DC I Path Compensation during 6dB */
        volatile unsigned int rf_dc_q_comp_6db : 8;  /**< RF DC Q Path Compensation during 6dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x25_TypeDef;
#if 0
Seg2=rf_dc_q_comp_6db |15:8 |0h | |RF DC Q Path Compensation during 6dB
Seg3=rf_dc_i_comp_6db |7:0 |0h | |RF DC I Path Compensation during 6dB
#endif
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_9db : 8;  /**< RF DC I Path Compensation during 9dB */
        volatile unsigned int rf_dc_q_comp_9db : 8;  /**< RF DC Q Path Compensation during 9dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x26_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_12db : 8;  /**< RF DC I Path Compensation during 12dB */
        volatile unsigned int rf_dc_q_comp_12db : 8;  /**< RF DC Q Path Compensation during 12dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x27_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_15db : 8;  /**< RF DC I Path Compensation during 15dB */
        volatile unsigned int rf_dc_q_comp_15db : 8;  /**< RF DC Q Path Compensation during 15dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x28_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_18db : 8;  /**< RF DC I Path Compensation during 18dB */
        volatile unsigned int rf_dc_q_comp_18db : 8;  /**< RF DC Q Path Compensation during 18dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x29_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_21db : 8;  /**< RF DC I Path Compensation during 21dB */
        volatile unsigned int rf_dc_q_comp_21db : 8;  /**< RF DC Q Path Compensation during 21dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x2A_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_24db : 8;  /**< RF DC I Path Compensation during 24dB */
        volatile unsigned int rf_dc_q_comp_24db : 8;  /**< RF DC Q Path Compensation during 24dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x2B_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_27db : 8;  /**< RF DC I Path Compensation during 27dB */
        volatile unsigned int rf_dc_q_comp_27db : 8;  /**< RF DC Q Path Compensation during 27dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x2C_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_30db : 8;  /**< RF DC I Path Compensation during 30dB */
        volatile unsigned int rf_dc_q_comp_30db : 8;  /**< RF DC Q Path Compensation during 30dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x2D_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_33db : 8;  /**< RF DC I Path Compensation during 33dB */
        volatile unsigned int rf_dc_q_comp_33db : 8;  /**< RF DC Q Path Compensation during 33dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x2E_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_36db : 8;  /**< RF DC I Path Compensation during 36dB */
        volatile unsigned int rf_dc_q_comp_36db : 8;  /**< RF DC Q Path Compensation during 36dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x2F_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_39db : 8;  /**< RF DC I Path Compensation during 39dB */
        volatile unsigned int rf_dc_q_comp_39db : 8;  /**< RF DC Q Path Compensation during 39dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x30_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_42db : 8;  /**< RF DC I Path Compensation during 42dB */
        volatile unsigned int rf_dc_q_comp_42db : 8;  /**< RF DC Q Path Compensation during 42dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x31_TypeDef;
...
typedef union
{
    struct
    {
        volatile unsigned int rf_dc_i_comp_45db : 8;  /**< RF DC I Path Compensation during 45dB */
        volatile unsigned int rf_dc_q_comp_45db : 8;  /**< RF DC Q Path Compensation during 45dB */
        volatile unsigned int Reserved         : 16; /**< NC */
    } bits;
    volatile unsigned int value;
} BK7011_RC_BEKEN_REG0x32_TypeDef;
...
/// BK7231N_RC_REG, total 48 registers, no RC07\ RC1D\ RC1E
struct BK7011RCBEKEN_TypeDef
{
    volatile BK7011_RC_BEKEN_REG0x0_TypeDef  *REG0x0;
    volatile BK7011_RC_BEKEN_REG0x1_TypeDef  *REG0x1;
    volatile BK7011_RC_BEKEN_REG0x2_TypeDef  *REG0x2;
    volatile BK7011_RC_BEKEN_REG0x3_TypeDef  *REG0x3;
    volatile BK7011_RC_BEKEN_REG0x4_TypeDef  *REG0x4;
    volatile BK7011_RC_BEKEN_REG0x5_TypeDef  *REG0x5;
    volatile BK7011_RC_BEKEN_REG0x6_TypeDef  *REG0x6;
    volatile BK7011_RC_BEKEN_REG0x8_TypeDef  *REG0x8;
    volatile BK7011_RC_BEKEN_REG0x9_TypeDef  *REG0x9;
    volatile BK7011_RC_BEKEN_REG0xA_TypeDef  *REG0xA;
    volatile BK7011_RC_BEKEN_REG0xB_TypeDef  *REG0xB;
    volatile BK7011_RC_BEKEN_REG0xC_TypeDef  *REG0xC;
    volatile BK7011_RC_BEKEN_REG0xD_TypeDef  *REG0xD;
    volatile BK7011_RC_BEKEN_REG0xE_TypeDef  *REG0xE;
    volatile BK7011_RC_BEKEN_REG0xF_TypeDef  *REG0xF;
    volatile BK7011_RC_BEKEN_REG0x10_TypeDef  *REG0x10;
    volatile BK7011_RC_BEKEN_REG0x11_TypeDef  *REG0x11;
    volatile BK7011_RC_BEKEN_REG0x12_TypeDef  *REG0x12;
    volatile BK7011_RC_BEKEN_REG0x13_TypeDef  *REG0x13;
    volatile BK7011_RC_BEKEN_REG0x14_TypeDef  *REG0x14;
    volatile BK7011_RC_BEKEN_REG0x15_TypeDef  *REG0x15;
    volatile BK7011_RC_BEKEN_REG0x16_TypeDef  *REG0x16;
    volatile BK7011_RC_BEKEN_REG0x17_TypeDef  *REG0x17;
    volatile BK7011_RC_BEKEN_REG0x18_TypeDef  *REG0x18;
    volatile BK7011_RC_BEKEN_REG0x19_TypeDef  *REG0x19;
    volatile BK7011_RC_BEKEN_REG0x1A_TypeDef  *REG0x1A;
    volatile BK7011_RC_BEKEN_REG0x1B_TypeDef  *REG0x1B;
    volatile BK7011_RC_BEKEN_REG0x1C_TypeDef  *REG0x1C;
    volatile BK7011_RC_BEKEN_REG0x1F_TypeDef  *REG0x1F;
    volatile BK7011_RC_BEKEN_REG0x20_TypeDef  *REG0x20;
    volatile BK7011_RC_BEKEN_REG0x21_TypeDef  *REG0x21;
    volatile BK7011_RC_BEKEN_REG0x22_TypeDef  *REG0x22;
    volatile BK7011_RC_BEKEN_REG0x23_TypeDef  *REG0x23;
    volatile BK7011_RC_BEKEN_REG0x24_TypeDef  *REG0x24;
    volatile BK7011_RC_BEKEN_REG0x25_TypeDef  *REG0x25;
    volatile BK7011_RC_BEKEN_REG0x26_TypeDef  *REG0x26;
    volatile BK7011_RC_BEKEN_REG0x27_TypeDef  *REG0x27;
    volatile BK7011_RC_BEKEN_REG0x28_TypeDef  *REG0x28;
    volatile BK7011_RC_BEKEN_REG0x29_TypeDef  *REG0x29;
    volatile BK7011_RC_BEKEN_REG0x2A_TypeDef  *REG0x2A;
    volatile BK7011_RC_BEKEN_REG0x2B_TypeDef  *REG0x2B;
    volatile BK7011_RC_BEKEN_REG0x2C_TypeDef  *REG0x2C;
    volatile BK7011_RC_BEKEN_REG0x2D_TypeDef  *REG0x2D;
    volatile BK7011_RC_BEKEN_REG0x2E_TypeDef  *REG0x2E;
    volatile BK7011_RC_BEKEN_REG0x2F_TypeDef  *REG0x2F;
    volatile BK7011_RC_BEKEN_REG0x30_TypeDef  *REG0x30;
    volatile BK7011_RC_BEKEN_REG0x31_TypeDef  *REG0x31;
    volatile BK7011_RC_BEKEN_REG0x32_TypeDef  *REG0x32;
};
...
typedef struct
{
    ...
    BK7011_RC_BEKEN_REG0x2_TypeDef  REG0x2;
    BK7011_RC_BEKEN_REG0x3_TypeDef  REG0x3;
    BK7011_RC_BEKEN_REG0x4_TypeDef  REG0x4;
    BK7011_RC_BEKEN_REG0x5_TypeDef  REG0x5;
    BK7011_RC_BEKEN_REG0x6_TypeDef  REG0x6;
    BK7011_RC_BEKEN_REG0x8_TypeDef  REG0x8;
    BK7011_RC_BEKEN_REG0x9_TypeDef  REG0x9;
    BK7011_RC_BEKEN_REG0xA_TypeDef  REG0xA;
    BK7011_RC_BEKEN_REG0xB_TypeDef  REG0xB;
    BK7011_RC_BEKEN_REG0xC_TypeDef  REG0xC;
    BK7011_RC_BEKEN_REG0xD_TypeDef  REG0xD;
    BK7011_RC_BEKEN_REG0xE_TypeDef  REG0xE;
    BK7011_RC_BEKEN_REG0xF_TypeDef  REG0xF;
    BK7011_RC_BEKEN_REG0x10_TypeDef  REG0x10;
    BK7011_RC_BEKEN_REG0x11_TypeDef  REG0x11;
    BK7011_RC_BEKEN_REG0x12_TypeDef  REG0x12;
    BK7011_RC_BEKEN_REG0x13_TypeDef  REG0x13;
    BK7011_RC_BEKEN_REG0x14_TypeDef  REG0x14;
    BK7011_RC_BEKEN_REG0x15_TypeDef  REG0x15;
    BK7011_RC_BEKEN_REG0x16_TypeDef  REG0x16;
    BK7011_RC_BEKEN_REG0x17_TypeDef  REG0x17;
    BK7011_RC_BEKEN_REG0x18_TypeDef  REG0x18;
    BK7011_RC_BEKEN_REG0x19_TypeDef  REG0x19;
    BK7011_RC_BEKEN_REG0x1A_TypeDef  REG0x1A;
    BK7011_RC_BEKEN_REG0x1B_TypeDef  REG0x1B;
    BK7011_RC_BEKEN_REG0x1C_TypeDef  REG0x1C;
    BK7011_RC_BEKEN_REG0x1F_TypeDef  REG0x1F;
    BK7011_RC_BEKEN_REG0x20_TypeDef  REG0x20;
    BK7011_RC_BEKEN_REG0x21_TypeDef  REG0x21;
    BK7011_RC_BEKEN_REG0x22_TypeDef  REG0x22;
    BK7011_RC_BEKEN_REG0x23_TypeDef  REG0x23;
    BK7011_RC_BEKEN_REG0x24_TypeDef  REG0x24;
    BK7011_RC_BEKEN_REG0x25_TypeDef  REG0x25;
    BK7011_RC_BEKEN_REG0x26_TypeDef  REG0x26;
    BK7011_RC_BEKEN_REG0x27_TypeDef  REG0x27;
    BK7011_RC_BEKEN_REG0x28_TypeDef  REG0x28;
    BK7011_RC_BEKEN_REG0x29_TypeDef  REG0x29;
    BK7011_RC_BEKEN_REG0x2A_TypeDef  REG0x2A;
    BK7011_RC_BEKEN_REG0x2B_TypeDef  REG0x2B;
    BK7011_RC_BEKEN_REG0x2C_TypeDef  REG0x2C;
    BK7011_RC_BEKEN_REG0x2D_TypeDef  REG0x2D;
    BK7011_RC_BEKEN_REG0x2E_TypeDef  REG0x2E;
    BK7011_RC_BEKEN_REG0x2F_TypeDef  REG0x2F;
    BK7011_RC_BEKEN_REG0x30_TypeDef  REG0x30;
    BK7011_RC_BEKEN_REG0x31_TypeDef  REG0x31;
    BK7011_RC_BEKEN_REG0x32_TypeDef  REG0x32;
} BK7231N_RC_TypeDef;
#endif
...
/// BK7011TRxV2A, total 15 regiters
