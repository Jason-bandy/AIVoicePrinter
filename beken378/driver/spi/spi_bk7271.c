...
static const SDD_OPERATIONS spi_op = {
	spi_ctrl
};
...
void spi_init(void)
{
	...
	sddev_register_dev(SPI_DEV_NAME, (SDD_OPERATIONS*)&spi_op);
}

void spi2_init(void)
{
	intc_service_register(IRQ_SPI2, PRI_IRQ_SPI, spi_isr);
	sddev_register_dev(SPI2_DEV_NAME, (SDD_OPERATIONS*)&spi_op);
}

void spi3_init(void)
{
	intc_service_register(IRQ_SPI3, PRI_IRQ_SPI, spi_isr);
	sddev_register_dev(SPI3_DEV_NAME, (SDD_OPERATIONS*)&spi_op);
}
