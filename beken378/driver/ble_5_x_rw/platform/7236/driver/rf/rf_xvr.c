...
void xvr_reg_init(void)
{
	...
	*((volatile unsigned long *)(0x01050200)) = 0x200;
	...
	REG_WRITE(BLE_XVR_REG2A, 0x12083A3E);
#else
	...
	REG_WRITE(BLE_XVR_REG30, 0xA1419980);//<11:10>=2 by qunshan20201228 for rx
	...
	REG_WRITE(BLE_XVR_REG3C, 0x267D1C01);
...
void rf_init(struct rwip_rf_api *api)
{
...
#if (BLE_PHY_CODED_SUPPORT)
	ble_radiopwrupdn1_set(0x00500050);
#else
...
#if (BLE_PHY_CODED_SUPPORT)
	ble_radiopwrupdn2_set(0x00500050);
#else
	...
	ble_radiotxrxtim0_set(0x00100606);  //0x00001007
	...
	ble_radiotxrxtim1_set(0x00100C04);
...
#if (BLE_PHY_CODED_SUPPORT)
	ble_radiotxrxtim2_set(0x39282020);
#else
	ble_radiotxrxtim2_set(0x00282020);
#endif
...
#if (BLE_PHY_CODED_SUPPORT)
	ble_radiotxrxtim3_set(0x10380007);
#else
	ble_radiotxrxtim3_set(0x10380007);
#endif
