...
enum
{
	...
	I2C1_CMD_SET_SMBUS_CS,
	I2C1_CMD_SET_TIMEOUT_EN,
	I2C1_CMD_SET_FREE_DETECT,
	I2C1_CMD_SET_SLAVE_EN,
	I2C1_CMD_SET_SMBUS_EN,
	I2C1_CMD_SET_POWER_UP,
	I2C1_CMD_SET_POWER_DOWN,
	I2C1_CMD_GET_MESSAGE,
	I2C1_CMD_GET_BUSY,
};
#else
enum
