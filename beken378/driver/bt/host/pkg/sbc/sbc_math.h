...
#define SCALE4_STAGED3_BITS	12
#define SCALE8_STAGED3_BITS	12
#define SCALE4_STAGED3(src) ASR(src, SCALE4_STAGED3_BITS)
#define SCALE8_STAGED3(src) ASR(src, SCALE8_STAGED3_BITS)
#endif
