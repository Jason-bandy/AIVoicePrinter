...
__INLINE__ int MULSHIFT32(int x, int y)	
{
...
__INLINE__ Word64 MADD64(Word64 sum, int x, int y)
{
...
__INLINE__ Word64 SHL64(Word64 x, int n)
{
...
__INLINE__ Word64 SAR64(Word64 x, int n)
{
	unsigned int xLo = ((unsigned int *)&x)[0];
	int xHi = ((int *)&x)[1];
	unsigned char nb = (unsigned char)n;
