...
}__PACKED_POST__ bt_a2dp_mpeg_1_2_audio_t;
...
}__PACKED_POST__ bt_a2dp_mpeg_aac_t;
...
typedef struct {
    ...
    uint8_t     octet5;
    uint8_t     octet6;
}__PACKED_POST__ bt_a2dp_atrac_t;

typedef union a2dp_codec_u_t {
        bt_a2dp_sbc_t             sbc;
        bt_a2dp_mpeg_1_2_audio_t  mpeg_1_2_audio;
        bt_a2dp_mpeg_aac_t        mpeg_aac;
        bt_a2dp_atrac_t           atrac;
}__PACKED_POST__ a2dp_codec_u_t;
