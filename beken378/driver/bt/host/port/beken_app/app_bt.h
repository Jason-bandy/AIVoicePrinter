...
int bt_flag1_is_set(uint32 flag);
int bt_flag2_is_set(uint32 flag);
void bt_flag1_operate(uint32 flag, uint8 oper);
void bt_flag2_operate(uint32 flag, uint8 oper);
...
extern void set_2hfps_sco_and_incoming_flag(uint8_t val);
extern uint8_t get_2hfps_sco_and_incoming_flag(void);
