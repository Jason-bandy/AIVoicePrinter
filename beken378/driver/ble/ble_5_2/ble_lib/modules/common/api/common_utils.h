...
#define COMMON_BIT_CNT(val) (common_bit_cnt((uint8_t*) &(val), sizeof(val)))
...
extern const uint8_t common_phypwr_value_to_mask[];

/// Convert PHY mask bit of power control to the corresponding PHY rate value
extern const uint8_t common_phypwr_mask_to_value[];

/// Convert PHY rate value of power control to Rate value
extern const uint8_t common_phypwr_to_rate[];

/// Convert Rate value to PHY rate value of power control
extern const uint8_t common_rate_to_phypwr[];

/// Convert Rate value to PHY mask value of power control
extern const uint8_t common_rate_to_phypwr_mask[];

#endif // BLE_PWR_CTRL

/// Convert Rate value to byte duration in us
extern const uint8_t common_rate_to_byte_dur_us[];
 ...
 ****************************************************************************************
 */
__INLINE uint8_t common_bit_cnt(const uint8_t* p_val, uint8_t size)
{
    uint8_t nb_bit = 0;
    while(size-- > 0)
    {
