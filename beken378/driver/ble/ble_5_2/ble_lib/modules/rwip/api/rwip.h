...
#define RWIP_PRIO_INC(prio_idx) (rwip_priority[prio_idx].increment + COMMON_MOD(common_rand_byte(), RWIP_PRIO_MAX_RAND_INC))
#if (RW_WLAN_COEX || RW_MWS_COEX)
 ...
 ****************************************************************************************
 */
void rwip_timer_common_set(uint32_t target_bts);
...
unsigned int get_em_map_end(void);
