...
ifeq ($(CFG_IEEE80211AX),1)
IP_DIR := ip_ax/macsw/ip
else
IP_DIR := ip
endif
...
INCLUDES += -I./beken378/$(IP_DIR)/common
INCLUDES += -I./beken378/$(IP_DIR)/ke/
INCLUDES += -I./beken378/$(IP_DIR)/mac/
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/hal
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/mm
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/ps
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/rd
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/rwnx
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/rx
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/scan
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/sta
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/tx
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/vif
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/rx/rxl
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/tx/txl
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/p2p
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/chan
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/td
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/tpc
INCLUDES += -I./beken378/$(IP_DIR)/lmac/src/tdls
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/mesh
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/mfp
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/rc
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/apm
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/bam
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/llc
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/me
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/rxu
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/rm
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/scanu
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/sm
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/twt
INCLUDES += -I./beken378/$(IP_DIR)/umac/src/txu

ifeq ($(CFG_IEEE80211AX),1)
INCLUDES += -I./beken378/ip_ax/macsw/ip/umac/src/hsu
INCLUDES += -I./beken378/ip_ax/macsw/modules/common/src
INCLUDES += -I./beken378/ip_ax/macsw/modules/dbg/src
INCLUDES += -I./beken378/ip_ax/macsw/modules/fhost/src
INCLUDES += -I./beken378/ip_ax/macsw/modules/ke/src
INCLUDES += -I./beken378/ip_ax/macsw/modules/mac/src
INCLUDES += -I./beken378/ip_ax/macsw/modules/macif/src
INCLUDES += -I./beken378/ip_ax/macsw/plf/refip/src/driver/crm
INCLUDES += -I./beken378/ip_ax/macsw/plf/refip/src/driver/dma
INCLUDES += -I./beken378/ip_ax/rwnx_drv/regs
else
...
ifeq ($(CFG_IEEE80211AX),1)
INCLUDES += -I./beken378/driver/phy_karst
else
...
ifeq ($(CFG_SOC_NAME),$(SOC_BK7236))
INCLUDES += -I./beken378/driver/ble_5_x_rw/platform/7236/rwip/api
INCLUDES += -I./beken378/driver/ble_5_x_rw/platform/7236/rwip/import/reg
INCLUDES += -I./beken378/driver/ble_5_x_rw/platform/7236/nvds/api
INCLUDES += -I./beken378/driver/ble_5_x_rw/platform/7236/config
INCLUDES += -I./beken378/driver/ble_5_x_rw/platform/7236/driver/reg
INCLUDES += -I./beken378/driver/ble_5_x_rw/platform/7236/driver/rf
INCLUDES += -I./beken378/driver/ble_5_x_rw/platform/7236/driver/uart
INCLUDES += -I./beken378/driver/ble_5_x_rw/platform/7236/entry
endif
...
ifeq ($(CFG_USE_USB_HOST), 1)
INCLUDES += -I./beken378/driver/usb/src/systems/os/afs
INCLUDES += -I./beken378/driver/usb/src/systems/os
endif
endif
...
ifeq ($(CFG_SOC_NAME), 4)
ifeq ($(CFG_USE_BT), 1)
INCLUDES += -I./beken378/driver/bt
INCLUDES += -I./beken378/driver/bt/Common/include
INCLUDES += -I./beken378/driver/bt/host/include
INCLUDES += -I./beken378/driver/bt/host/config
INCLUDES += -I./beken378/driver/bt/host/jos
INCLUDES += -I./beken378/driver/bt/host/jos/include
INCLUDES += -I./beken378/driver/bt/host/pkg/sbc
INCLUDES += -I./beken378/driver/bt/host/bluetooth/core
INCLUDES += -I./beken378/driver/bt/host/bluetooth/include
INCLUDES += -I./beken378/driver/bt/host/bluetooth/service
INCLUDES += -I./beken378/driver/bt/host/bluetooth/profile/a2dp
INCLUDES += -I./beken378/driver/bt/host/bluetooth/protocol/avctp
INCLUDES += -I./beken378/driver/bt/host/bluetooth/protocol/avdtp
INCLUDES += -I./beken378/driver/bt/host/bluetooth/protocol/rfcomm
INCLUDES += -I./beken378/driver/bt/host/port/beken_app
INCLUDES += -I./beken378/driver/bt/host/port/beken_driver
INCLUDES += -I./beken378/driver/bt/host/port/beken_no_os
INCLUDES += -I./beken378/driver/bt/host/port/beken_no_os/pts
INCLUDES += -I./beken378/driver/bt/host/port/common
INCLUDES += -I./beken378/driver/bt/host/port/common/bluetooth
INCLUDES += -I./beken378/driver/bt/host/port/include
INCLUDES += -I./beken378/driver/bt/host/port/include/bluetooth
INCLUDES += -I./beken378/driver/bt/host/port/include/os
endif
endif
...
SRC_C += ./beken378/driver/dsp/dsp.c
...
ifeq ($(CFG_IEEE80211AX),1)
SRC_C += ./beken378/driver/phy_karst/phy_karst.c
else
...
# For BK7271
ifeq ($(CFG_SOC_NAME), 4)
SRC_C += ./beken378/driver/gpio/gpio_bk7271.c
SRC_C += ./beken378/driver/spi/spi_bk7271.c
SRC_C += ./beken378/driver/spi/spi_slave_bk7271.c
SRC_C += ./beken378/driver/spi/spi_master_bk7271.c
SRC_C += ./beken378/driver/i2c/i2c1_bk7271.c
SRC_C += ./beken378/driver/mailbox/mailbox.c
SRC_C += ./beken378/driver/pwm/pwm_bk7271.c
SRC_C += ./beken378/driver/pwm/timer_bk7271.c
endif
...
SRC_C += ./beken378/func/bk7011_cal/bk7236_cal.c
SRC_C += ./beken378/func/bk7011_cal/manual_cal_bk7231U.c
SRC_C += ./beken378/func/bk7011_cal/manual_cal_bk7236.c
SRC_C += ./beken378/func/bk7011_cal/bk_pwr_tbl.c
SRC_C += ./beken378/func/joint_up/role_launch.c

# For BK7271
ifeq ($(CFG_SOC_NAME), 4)
SRC_C += ./beken378/func/bk7011_cal/bk7271_cal.c
endif
...
ifeq ($(CFG_IEEE80211AX),1)
SRC_C += ./beken378/func/rwnx_intf/rwnx_params.c
SRC_C += ./beken378/func/rwnx_intf/rwnx_rx.c
endif
...
SRC_C += ./beken378/func/user_driver/BkDriverQspi.c
...
ifeq ($(CFG_SOC_NAME), 4)
SRC_C += ./beken378/driver/audio/audio.c
SRC_C += ./beken378/func/wlan_ui/bk7271_dsp_cli.c
SRC_C += ./beken378/driver/audio/ring_buffer.c
endif
...
ifeq ($(CFG_SOC_NAME),$(SOC_BK7236))
SRC_C += ./beken378/driver/ble_5_x_rw/platform/7236/rwip/src/rwip.c
SRC_C += ./beken378/driver/ble_5_x_rw/platform/7236/rwip/src/rwble.c
SRC_C += ./beken378/driver/ble_5_x_rw/platform/7236/entry/ble_main.c
SRC_C += ./beken378/driver/ble_5_x_rw/platform/7236/driver/rf/rf_xvr.c
SRC_C += ./beken378/driver/ble_5_x_rw/platform/7236/driver/rf/ble_rf_port.c
SRC_C += ./beken378/driver/ble_5_x_rw/platform/7236/driver/uart/uart_ble.c
endif
...
ifeq ($(CFG_SOC_NAME), 4)
ifeq ($(CFG_USE_BT), 1)
SRC_C += ./beken378/driver/bt/bt.c
SRC_C += ./beken378/driver/bt/ble_dm.c
endif
endif
...
ifeq ($(CFG_PCM_RESAMPLER),1)
SRC_C += ./beken378/func/pcm_resampler/pcm_resampler_port.c
endif
...
SRC_IP_C =
ifeq ($(CFG_IEEE80211AX),1)
-include ./beken378/ip_ax/ip_lib_src.mk
else
...
ifeq ($(CFG_SOC_NAME), 4)
ifeq ($(CFG_USE_BT), 1)
-include ./beken378/driver/bt/bt_lib_src.mk
endif
endif
