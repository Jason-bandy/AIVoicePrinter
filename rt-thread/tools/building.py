...
def PrepareBuilding(env, root_directory, has_libcpu=False, remove_components = []):
    ...
    if GetOption('buildlibs'):
        if GetOption('beken') == 'bk7231n':
            ...
            DoSystemCall("scons --beken=bk7231n --buildlib=beken_pcm_resampler -j8")
            ...
            DoSystemCall("scons --beken=bk7236 --buildlib=beken_pcm_resampler -j8")
            ...
            DoSystemCall("scons --beken=bk7251 --buildlib=beken_pcm_resampler -j8")
    ...
    if GetOption('cleanlibs'):
        if GetOption('beken') == 'bk7231n':
            ...
            DoSystemCall("scons --beken=bk7231n --cleanlib=beken_pcm_resampler -j8")
        elif GetOption('beken') == 'bk7231u':
            ...
            DoSystemCall("scons --beken=bk7236 --cleanlib=beken_pcm_resampler -j8")
        elif GetOption('beken') == 'bk7271':
            ...
            DoSystemCall("scons --beken=bk7251 --cleanlib=beken_pcm_resampler -j8")
